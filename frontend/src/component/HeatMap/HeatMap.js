...
function HeatMap(){
  // <!-- 生成投篮数据的坐标(x, y) -->
   ...
   for (var i = 0; i < 100; i++) {
     var bin_x = Math.floor(x[i] / (880 / bins));
     var bin_y = Math.floor(y[i] / (497 / bins));
     heatmap[bin_x][bin_y]++;
   }
   ...
   for (var i = 0; i < bins; i++) {
     for (var j = 0; j < bins; j++) {
       ...
       if (value > 0) {
         ...
         var cx = (i + 0.5) * (880 / bins);
         var cy = (j + 2.5) * (497 / bins);
        ...
        >
          ...
          <Row>
           ...
           <div className='HeatMap'>
              <svg  width="880" height="497" > 
                  <image xlinkHref={BasketballBg} width="880" height="497" />
                  <g>
                  <rect x="0" y="0" width="880" height="497" fill="none" pointerEvents="all" />
                  <g id="hotspots"></g>
                  </g>
              </svg >  
           </div> 
